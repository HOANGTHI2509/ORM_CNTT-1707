    ...
    def action_done(self):
        for record in self:
            if record.state == 'approved':
                ...
                # Bắn thông báo Zalo báo trì xong
                msg = f"✅ Tài sản '{record.tai_san_id.ten_tai_san}' (Mã: {record.tai_san_id.ma_tai_san}) đã được bảo trì xong."
                if record.tai_san_id.quan_ly_id:
                    self._gui_thong_bao_zalo(record.tai_san_id.quan_ly_id, msg)
                elif record.tai_san_id.nguoi_dang_dung_id:
                    self._gui_thong_bao_zalo(record.tai_san_id.nguoi_dang_dung_id, msg)
